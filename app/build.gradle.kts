...
android {
    namespace = "com.example.androidadaptivelayout"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.androidadaptivelayout"
        minSdk = 28
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
//    implementation("androidx.compose.material3.adaptive:adaptive-navigation:1.1.0-alpha04")
    ...
    implementation("androidx.navigation:navigation-compose:2.5.0") // or latest version
